...
const CTALayout2 = ({ block }: { block: CTABlockData }) => {
    ...
    return (
        <div
            className={`relative py-10 md:py-16 md:w-full my-16   flex flex-col ${align} md:flex-row justify-center items-center text-center rounded-2xl px-6 md:px-14`}
            style={{
        ...
        >
            ...
            <div className='flex flex-col gap-3 mt-8 relative items-center md:items-end md:w-[30%]'>
                {
