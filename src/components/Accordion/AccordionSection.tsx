...
const GRID = {
    "Layout 1": dynamic(() => import("./layouts/AccordionLayout1"), { ssr: true }), 
    "Layout 2": dynamic(() => import("./layouts/AccordionLayout2"), { ssr: true }),
     "Layout 3": dynamic(() => import("./layouts/AccordionLayout3"), { ssr: true }),
...
export default function FaqSection({ block }: { block: AccordionBlockData }) {
    const {  layout } = block;
