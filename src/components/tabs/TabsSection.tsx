...
const GRID = {
    "Layout 1": dynamic(() => import("./layouts/TabsLayout1"), { ssr: true }), 
    "Layout 2": dynamic(() => import("./layouts/TabsLayout2"), { ssr: true }),
     "Layout 3": dynamic(() => import("./layouts/TabsLayout3"), { ssr: true }),
...
export default function TabsSection({ block }: { block: TabsBlockData }) {
    const {  layout } = block;
