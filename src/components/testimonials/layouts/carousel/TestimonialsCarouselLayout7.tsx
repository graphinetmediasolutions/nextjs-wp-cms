...
export default function TestimonialsCarouselLayout7({ block }: { block: TestimonialBlockData }) {
      ...
      <div className="flex justify-center items-center gap-y-8 lg:gap-y-0 flex-wrap md:flex-wrap lg:flex-nowrap lg:flex-row lg:justify-between lg:gap-x-8 max-w-sm sm:max-w-2xl lg:max-w-full mx-auto">
        ...
        <div className="w-full lg:w-3/5">
          ...
          <BaseCarousel<TestimonialItem>
            items={visibleItems}
            className="testimonial-layout-carousel-seven"
            ...
            renderItem={(item, index) => (
              ...
              <div className="group bg-white border border-solid border-gray-300 rounded-2xl h-full  p-6 transition-all duration-500 hover:border-primary">
