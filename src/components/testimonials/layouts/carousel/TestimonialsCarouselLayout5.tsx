...
export default function TestimonialsCarouselLayout5({ block }: { block: TestimonialBlockData }) {
  const {
    items,
    displayPerRow = 3,
    sliderPerScroll = 1,
  ...
  return (
    <>
      ...
      <BaseCarousel<TestimonialItem>
        items={items}
        className="testimonial-layout-carousel-five"
        ...
        renderItem={(item, index) => (
          <div key={index} className=" bg-black text-white rounded-2xl">
