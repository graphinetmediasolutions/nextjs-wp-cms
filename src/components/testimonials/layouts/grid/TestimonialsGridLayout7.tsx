          ...
          <div className={`grid gap-6 ${gridCols}`}>
            {Array.isArray(items) &&
              ...
              items.map((item, index) => (
                ...
                <div key={item?.name?.replace(/\s+/g, "") ?? index} className="group bg-white border border-solid border-gray-300 rounded-2xl h-full  p-6 transition-all duration-500 hover:border-primary">
