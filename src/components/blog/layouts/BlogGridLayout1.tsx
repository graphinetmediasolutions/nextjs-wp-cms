...
export default function BlogGridLayout1({ items }: { items: BlogItem[] }) {
  return (
        ...
        >
          ...
          <div className="py-4 space-y-2">
            ...
            {item?.excerpt && (
             ...
             <Link href="#" className="view-more-link flex gap-2 items-center capitalize text-md text-primary"><MoveUpRight size={20} /> read more</Link>
          </div>
        </div>
      ))}
