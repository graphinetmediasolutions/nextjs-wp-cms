...
export default function TeamsCarouselLayout1({ block }: { block: TeamsBlockData }) {
  const {
    items,
    displayPerRow = 3,
    sliderPerScroll = 1,
  ...
  return (
    <>
      ...
      <BaseCarousel<TeamItem>
        items={visibleItems}
        className="teams-layout-carousel-one"
        ...
        renderItem={(item, index) => (
          <div className="card w-full h-full">
            <div className="advisory-board-image-card h-full flex flex-col justify-between items-start rounded-xl border-2 border-primary bg-white p-6">
              <div className="w-full">
                <div
                  className="relative w-full after:absolute after:inset-0 after:bg-black/20 after:z-[1] after:w-full after:h-full after:pointer-events-none after:rounded-lg overflow-hidden">
                  <div className="video-container h-[24rem]">
                    ...
                    <div className="card-img-overlay absolute bottom-[20px] left-[20px] z-[10]">
                      {
                      ...
                      }
                      {
                        item?.designation && <SafeHeading
                          position="Left"
                          className="heading-h4 text-sm text-white"
                          as="h4"
