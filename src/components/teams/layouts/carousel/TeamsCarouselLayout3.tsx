...
export default function TeamsCarouselLayout3({ block }: { block: TeamsBlockData }) {
  const {
    items,
    displayPerRow = 3,
    sliderPerScroll = 1,
  ...
  return (
    <>
      ...
      <BaseCarousel<TeamItem>
        items={visibleItems}
        className="teams-layout-carousel-three "
        ...
        renderItem={(item, index) => (
          ...
          <div className=" relative rounded-sm w-full h-full mt-24">

            <div className="w-32 h-32 absolute inset-0 -top-20 z-10 mx-auto rounded-full  border border-gray-200 bg-gray-100 overflow-hidden -mb-14">
            ...
            <div className="py-4 pt-24 bg-gray-200 text-center relative h-full">
              {item?.videoUrl && (
                <button
                  type="button"
