...
export default function TeamsCarouselLayout5({ block }: { block: TeamsBlockData }) {
  const {
    items,
    displayPerRow = 3,
    sliderPerScroll = 1,
  ...
  return (
    <>
      ...
      <BaseCarousel<TeamItem>
        items={visibleItems}
        className="teams-layout-carousel-five"
        ...
        renderItem={(item, index) => (
          <div className="bg-white relative w-full h-full rounded-lg shadow-md overflow-hidden hover:scale-[1.02] transition-all">
            ...
            <div className="w-36 h-36 border-4 border-white rounded-full -mt-[72px] shadow-xl mx-auto overflow-hidden">
