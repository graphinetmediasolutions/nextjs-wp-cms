...
const TeamsGridLayout3 = ({ block }: { block: TeamsBlockData }) => {
  ...
  return (
    <>
      ...
      <div className={`grid gap-6 ${gridCols} gap-x-6 gap-y-20 mt-24`}>
        {Array.isArray(items) &&
          items.length > 0 &&
          items?.slice(0, limit === -1 ? items.length : limit)?.map((item, index) => (
            <div key={`${item?.name?.replace(/\s+/g, "") || "item"}-${index}`} className=" lg:flex lg:items-center text-center ">

              <div className="bg-gray-200 relative rounded-sm w-full h-full">
                {item?.videoUrl && (
                  <button
                    type="button"
                  ...
                  >
                    <div className=" w-12 h-12 bg-opacity-75 rounded-full flex items-center justify-center hover:bg-opacity-90 transition">
                      <svg
                        width="40"
                        height="40"
                        fill="black"
                ...
                <div className="w-32 h-32 mx-auto rounded-full  border border-gray-200 bg-gray-100 overflow-hidden -mt-14">
                ...
                <div className="py-4">
                  ...
                  }
                  {
                    item?.designation && <SafeHeading
                      position="Center"
                      className="text-slate-600 text-[13px] mt-1"
                      as="h4"
...
export default TeamsGridLayout3;
